...
public partial class NorthwindContext : DbContext
{
    ...
    public virtual DbSet<MyAlbum> MyAlbums { get; set; }

    public virtual DbSet<MyAlbumCategory> MyAlbumCategories { get; set; }
...
//        => optionsBuilder.UseSqlServer("Data Source=.;Initial Catalog=Northwind;Integrated Security=True;Multiple Active Result Sets=True;Encrypt=True;Trust Server Certificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<MyAlbum>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__MyAlbum__3214EC079F1BAA02");

            entity.ToTable("MyAlbum");

            entity.Property(e => e.CategoryId).HasColumnName("CategoryID");
            entity.Property(e => e.PicName).HasMaxLength(50);
        });

        modelBuilder.Entity<MyAlbumCategory>(entity =>
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__MyAlbumC__3214EC07F23CB3A0");

            entity.ToTable("MyAlbumCategory");
